...
class UserProfileIfSingletonFactory : virtual public UserProfileIfFactory {
 public:
  UserProfileIfSingletonFactory(const boost::shared_ptr<UserProfileIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<UserProfileIf> iface_;
};
...
class UserProfileClient : virtual public UserProfileIf {
 public:
  UserProfileClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UserProfileClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class UserProfileProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  UserProfileProcessor(boost::shared_ptr<UserProfileIf> iface) :
    iface_(iface) {
...
class UserProfileProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  UserProfileProcessorFactory(const ::boost::shared_ptr< UserProfileIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< UserProfileIfFactory > handlerFactory_;
};

class UserProfileMultiface : virtual public UserProfileIf {
 public:
  UserProfileMultiface(std::vector<boost::shared_ptr<UserProfileIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~UserProfileMultiface() {}
 protected:
  std::vector<boost::shared_ptr<UserProfileIf> > ifaces_;
  UserProfileMultiface() {}
  void add(boost::shared_ptr<UserProfileIf> iface) {
...
class UserProfileConcurrentClient : virtual public UserProfileIf {
 public:
  UserProfileConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UserProfileConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
